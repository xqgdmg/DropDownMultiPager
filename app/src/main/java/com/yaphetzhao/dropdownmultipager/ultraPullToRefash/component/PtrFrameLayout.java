package com.yaphetzhao.dropdownmultipager.ultraPullToRefash.component;
...
import com.yaphetzhao.dropdownmultipager.ultraPullToRefash.handler.PtrHandler;
import com.yaphetzhao.dropdownmultipager.ultraPullToRefash.handler.PtrUIHandler;
import com.yaphetzhao.dropdownmultipager.ultraPullToRefash.handler.PtrUIHandlerHolder;
import com.yaphetzhao.dropdownmultipager.ultraPullToRefash.handler.PtrUIHandlerHook;
...
public class PtrFrameLayout extends ViewGroup {
    ...
    protected void onFinishInflate() {
        ...
        if (childCount > 2) {
            ...
            errorView.setTextColor(0x00000000);
    ...
    public boolean dispatchTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (Math.abs(downX - e.getRawX()) > 50 && Math.abs(downY - e.getRawY()) < 50) {
                    return dispatchTouchEventSupper(e);
                }
    ...
    class ScrollChecker implements Runnable {
        ...
        public void tryToScrollTo(int to, int duration) {
            ...
            // fix #47: Scroller should be reused, http://github.com/liaohuqiu/android-Ultra-Pull-To-Refresh/issues/47
            if (!mScroller.isFinished()) {
                mScroller.forceFinished(true);
            }
